        ...
        <>
            <Router>
                ...
                <Switch>
                    ...
                    <Route exact path="/san-pham-thien-van" component={Consumer} />
                    <Route exact path="/lien-he" component={Supplier} />
                    ...
                    <Route exact path="/admin/productlist/san-pham-thien-van/:id/edit" component={ConsumerListEdit} />
                    ...
                    <Route exact path="/dich-vu/purchaseSeeds" component={Farmer_ProductSeed} />
                    <Route exact path="/dich-vu/purchaseSeeds/:id" component={SeedProductScreen} />
                    <Route exact path="/dich-vu/lendMachines" component={Farmer_LendScreen} />
