...
const SeedProductScreen = ({ history, match }) => {
  ...
  return (
    <div className="productScreen">
      <Meta title="Yon | Kính thiên văn" />
      <Container>
        <Link className="btn btn-go-back btn-dark" to="/dich-vu/purchaseSeeds">
          Quay lại
        </Link>
        {loading ? (
          <Loader />
                ...
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    <Row>
                      <Col>Giá:</Col>
                      <Col>
                        <strong>{productSeed.price} VND</strong>
                      </Col>
                    </Row>
                  </ListGroup.Item>
                  <ListGroup.Item>
        ...
        <Row>
          <Col md={6}>
            <h2>Nhận xét</h2>
            {productSeed.reviews.length === 0 && <Message>Không nhận xét</Message>}
            <ListGroup variant="flush">
            ...
            <ListGroup>
              <ListGroup.Item>
                ...
                {userInfo ? (
                  ...
                  <p>
                    Hãy <Link to="/login">đăng nhập</Link> để nhận xét{" "}
                  </p>
                )}
              </ListGroup.Item>
            </ListGroup>
